...
export const INTEGRATIONS = {
  ...
  "openai-codex": {
    ...
    fields: [
      ...
      { key: "default_profile", label: "Codex profile (optional)", placeholder: "work", secret: false, required: false },
      { key: "default_add_dirs", label: "Extra writable directories (optional)", placeholder: "C:\\path\\one, C:\\path\\two", secret: false, required: false },
      { key: "default_timeout_seconds", label: "Timeout seconds (optional)", placeholder: "600", secret: false, required: false },
    ],
  },
  deepseek: {
