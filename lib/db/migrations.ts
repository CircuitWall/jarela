...
// automation history into interactive turns. One row per
// (thread_id, channel). Existing `threads.warm_summary*` columns are
// kept one release as a read-only fallback per the ADR.
