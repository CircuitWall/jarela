// Jira issue tools — search, get, create, update, comment, transition, link,
// bulk-create, attach, delete. Split out of the monolithic
// lib/tools/atlassian.ts in the bloat-audit refactor; the public surface
// (each `jira*Tool`) is re-exported from lib/tools/atlassian.ts so existing
