  ...
  async () => {
    return JSON.stringify({
      ...
      contract_paths: [
        ...
        "lib/tools/runtime/types.ts (OpenAITool, ToolContext, InvokeMessage)",
        "lib/tools/runtime/registry.ts (registerTools, ToolCategory, Capability)",
        "lib/tools/packages/langchain-package.ts (registerLangChainPackage)",
