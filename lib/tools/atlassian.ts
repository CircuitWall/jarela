...
// Re-export the tools + pure helpers so the existing test files
// (`lib/tools/atlassian*.test.ts`) and any other internal consumers can keep
// importing from `./atlassian`.
export {
  jiraSearchTool,
  jiraGetIssueTool,
  jiraCreateIssueTool,
