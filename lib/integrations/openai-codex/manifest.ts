...
export const openaiCodexManifest: IntegrationManifest = {
  ...
  steps: [
    ...
    },
    {
      ...
      description:
        "Propose enabling the integration and enter `codex` as the CLI command. A saved API key is optional and is intended only for trusted automated runs; leave it blank to use the Codex CLI's ChatGPT sign-in. Codex runs inherit your enabled Codex plugins, skills, MCP servers, and their own approval policies from the local or project config.",
