 ...
 * identity already vetted by proxy.ts's requireAccess + locked
 * allow-list). The PIN itself is still the security boundary and
 * brute-forcing is bounded by the per-remote rate limit.
 *
