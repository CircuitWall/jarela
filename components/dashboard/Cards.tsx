...
export function InsightChip({ label, value, hint, icon }: { label: string; value: string; hint: string; icon?: React.ReactNode }) {
  return (
    <div className="rounded-xl bg-[var(--bg-secondary)]/55 px-3 py-2.5">
      <div className="text-[10px] uppercase tracking-[0.12em] text-[var(--text-secondary)] inline-flex items-center gap-1">
        {icon}
        {label}
      </div>
