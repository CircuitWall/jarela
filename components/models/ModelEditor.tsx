          ...
          {showInternal ? (
            <>
              ...
              <div className="p-2.5 rounded-lg bg-surface-3 border border-border text-xs text-zinc-400">
                ...
                <p>B) Enter auth <strong>Username</strong> + <strong>Password</strong> (auto-fetches token)</p>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <label className="block">
                  <span className="text-xs text-zinc-400 mb-1 block">Username (auth)</span>
                  <input className="w-full bg-surface-3 text-zinc-100 text-sm rounded px-2 py-1.5 border border-border focus:outline-none focus:ring-1 focus:ring-accent"
                    value={username} onChange={(e) => setUsername(e.target.value)} placeholder="internal username" />
                </label>
                <label className="block">
                  <span className="text-xs text-zinc-400 mb-1 block">Password (auth)</span>
